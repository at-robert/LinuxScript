...
cp -fv ~/mtk8507/workspace_intext/dest/release/BDP_Generic/build/mt8507_bl_linux.bin $OUTPATH/mtk8507_bins/
cp -fv ~/mtk8507/FW/release_note_intext/Release\ Notes\ for\ VIZIO\ SB4451_3851_3831_3830_IntExt_V$VER.pdf $OUTPATH/release_note/
cp -fv ~/mtk8507/workspace_intext/dest/*.tar.gz $OUTPATH/mtk8507_source/
