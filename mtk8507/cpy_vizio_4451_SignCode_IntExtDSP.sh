...
NEWFOLDER=~/mtk8507/FW/INT_EXT_DSP/NEWSIGN
INPATH_MCU=~/mtk8507/FW/MCU/'4451_'$VER
INPATH=~/mtk8507/FW/Signed_intext/v$VER
OUTPATH=~/mtk8507/FW/INT_EXT_DSP/$VER'_PRO'
...
if [ "$1" == "" ] || [ "$2" == "" ];
then
    echo -e "using by ./cpy_vizio_4451_SignCode.sh $LIGHT_RED[VER] [SDK]$END"
    exit;
fi
...
echo -e "$LIGHT_RED Please generate MICRON flash bin file manually in [SU-6000_141225/build_emmc.bat]Windows environment and then $END"
